      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <motion.div 
              className={`hidden lg:flex items-center gap-1 font-mono text-xs ${
          ...
          <div className="hidden md:flex items-center space-x-1 font-mono">
            {navItems.map((item, index) => (
              <motion.button
                ...
                className={`px-4 py-2 transition-all text-xs rounded-lg backdrop-blur-sm relative group ${
                  isDarkMode 
          ...
          <div className="px-6 pt-2 pb-6 space-y-2">
            {navItems.map((item) => (
              <button
                key={item.id}
                onClick={() => scrollToSection(item.id)}
                className={`block w-full text-left px-4 py-3 rounded-lg transition-all font-mono text-sm border ${
                  isDarkMode 
